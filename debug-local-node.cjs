// Script para testar função parse-efd-emergency localmente com Node.js (CommonJS)
...
app.post('/', async (req, res) => {
  ...
  try {
    ...
    // Não testar criação de filial com chave anônima (não tem permissão)
    let filialTest = 'skipped_no_permissions';
    console.log("EMERGENCY LOCAL (Node): Skipping filial test (using anon key)");
